...
--------------------------------------------------------
  ...
  CREATE OR REPLACE PROCEDURE "AUTORIZACIONES"."P_VALIDATECOBERTURA_INT" (
            ...
            DAT_ASEG_ROW
              ...
              --
                    ...
                    IF c_valida_plan_excento%notfound THEN
                        IF NOT paq_matriz_validaciones.f_poliza_exento_restriccion(fonos_row.compania, fonos_row.ramo, fonos_row.secuencial,
                        fonos_row.plan, fonos_row.tip_ser,
                                                                                  fonos_row.tip_cob, fonos_row.cobertura, fonos_row.tip_rec,
                                                                                  fonos_row.afiliado, vusuario) THEN
                            ori_flag := paq_matriz_validaciones.busca_origen_cob(fonos_row.tip_ser, fonos_row.tip_cob, fonos_row.cobertura,
                            vusuario, fonos_row.ramo,
                                                                                fonos_row.compania);
                            ...
                            IF error IS NOT NULL THEN
                                vestudio_repeticion := f_busca_cob_estudio_repeticion(fonos_row.asegurado, fonos_row.dependiente, fonos_row.
                                compania, fonos_row.ramo, fonos_row.secuencial,
                    ...
                    -- Monto m�ximo que se pueda otorgar para esa cobertura por canales
                                vmon_max_cob_origen := f_busca_origen_cob_mon_max(fonos_row.tip_ser, fonos_row.tip_cob, fonos_row.cobertura,
                                vusuario);
                            END IF;
              ...
              --
                ...
                */
                  ...
                  --<84770> jdeveaux --> Se reemplaza por procesos que busca en SaludCore
                            limite_laboratorio := dbaper.paq_reclamacion_si.f_tip_cob_mon_max(fonos_row.compania, fonos_row.ramo, fonos_row.
                        ...
                        THEN
                            ...
                            des_tip_n_med, var_tip_a_uso,
                                                                                         ...
                                                                                         p_por_coa, p_monto_max, --A estaba dos veces--
                                                                                          pla_stc_row.exc_mca, pla_stc_row.mon_ded, v_categoria_int,
                                                                                         v_proveedor_int);
                  ...
                  --
                    ...
                    /* ---------------------------------------------------------- */
                                ...
                                compania, fonos_row.ramo,
                                                                                     fonos_row.sec_rec, fonos_row.tip_rec, fonos_row.
                                                                                     afiliado, var_tip_a_uso, cod_ase,
                                                                                     cod_dep, fonos_row.tip_ser, fonos_row.tip_cob, fonos_row.
                                                                                     cobertura, fecha_dia);
                      ...
                      /* ---------------------------------------------------------- */
                        ...
                        /* ---------------------------------------------------------- */
                                        IF NOT paq_matriz_validaciones.f_poliza_exento_restriccion(fonos_row.compania, fonos_row.ramo,
                          ...
                          --
                                            ...
                                            cod_ase, cod_dep,
                                                                                                 ...
                                                                                                 var_fec_ini, fonos_row.compania, fonos_row.
                                                                                                 ramo, fonos_row.secuencial, dsp_cob_lab,
                                                                                                 dsp_frec_tip_cob);
                          --
                                        END IF;
                        --
                          ...
                          /* ---------------------------------------------------------- */
                                            ...
                                            ramo, fonos_row.secuencial, fonos_row.plan, fonos_row.tip_ser,
                                                                                                      ...
                                                                                                      vusuario) THEN
                            --<84770> jdeveaux --> Se reemplaza por procesos que busca en SaludCore
                                                error := dbaper.paq_reclamacion_si.f_validar_frec_cobertura(true, var_estatus_can, var_tip_a_uso,
                                                cod_ase, cod_dep,
                                                                                                           ...
                                                                                                           secuencial,
                                                                                                           fonos_row.cobertura, fecha_dia,
                                                                                                           var_fec_ini, fonos_row.fec_ing,
                                                                                                           pla_stc_row.frecuencia,
                                                                                                           pla_stc_row.uni_tie_f, pla_stc_row.
                                                                                                           tie_esp, pla_stc_row.uni_tie_t,
                                                                                                           pla_stc_row.mon_max, pla_stc_row.
                                                                                                           uni_tie_m,
                                                                                                           dsp_frec_acum, dsp_mon_pag_acum,
                                                                                                           var_plan, trunc(sysdate), v_error_handler);
                            --
                                            END IF;
                          --</84770>
                          --
                              ...
                              --
                                                    ...
                                                    p_var_estatus_can => var_estatus_can, -- Cancelada en la Rec
                                                     p_tip_a_uso => var_tip_a_uso, p_ase_uso => cod_ase, p_dep_uso => cod_dep,
                                                                                                              ...
                                                                                                              p_servicio => fonos_row.
                                                                                                              tip_ser, p_tip_cob => fonos_row.
                                                                                                              tip_cob, p_cobertura =>
                                                                                                              fonos_row.cobertura, p_fec_ser =>
                                                                                                              fecha_dia,
                                                                                                              ...
                                                                                                              uni_tie_t, p_mon_max =>
                                                                                                              pla_stc_row.mon_max, p_uni_tie_m =>
                                                                                                              pla_stc_row.uni_tie_m, p_dsp_frec_acum =>
                                                                                                              var_dsp_frec_acum);
                            ...
                            --
                              ...
                              /*-------------------------------------------------------------- */
                                ...
                                /* ----------------------------------------------------------------------  */
                                                        t_fec_fin := paq_matriz_validaciones.determina_fecha_rango_fin(fecha_dia, var_fec_ini,
                                                        NULL, NULL, NULL,
                                                                                                                      p_mon_exe, nvl(
                                                                                                                      p_uni_t_exe, 365),
                                                                                                                      p_ran_u_exc);
                                ...
                                --<84770> jdeveaux --> Se reemplaza por procesos que busca en SaludCore
                                                        ...
                                                        cod_dep, fecha_dia, fonos_row.compania,
                                                                                                               ...
                                                                                                               fonos_row.tip_cob, var_estatus_can,
                                                                                                               t_fec_ini, t_fec_fin, var_tipo, -- Variable Provisional
                              ...
                              --Proceso que busca el deducible del plan elegido por el asegurado en SaludCore
                                                    ...
                                                    v_mon_disp_tc, no_m_cob_row.limite, --               ,
                                                                                                                ...
                                                                                                                tip_cob, fonos_row.secuencial,
                                                                                                                fonos_row.ramo, fonos_row.
                                                                                                                compania,
                                                                                                                fonos_row.ano_rec, 'A',
                                                                                                                'A', v_var_ind_ded, fonos_row.
                                                                                                                secuencial,
                                                                                                                fonos_row.plan, vafiliado_sal,
                                                                                                                var_tip_a_uso, fecha_dia,
                                                                                                                'L',
                                                                                                                'P', v_apl_ded_rie, v_ind_ded_rie,
                                                                                                                var_fec_ini, --t_fec_ini                            ,
                                                                                                                 dsp_fec_ing,
                                                                                                                fonos_row.tip_ser, fonos_row.
                                                                                                                cobertura, 'S', v_fec_i_car,
                                                                                                                v_fec_f_car,
                              ...
                              --<84770> jdeveaux --> Se reemplaza por procesos que busca en SaludCore
                                                    ...
                                                    fonos_row.afiliado, var_tip_a_uso, cod_ase, cod_dep,
                                                                                                                    ...
                                                                                                                    fecha_dia, por_coa,
                                                                                                                    no_m_cob_row.limite,
                                                                                                                    var_frecuencia, dsp_uni_tie_f,
                                                                                                                    var_uni_t_exe, v_mon_max,
                                                                                                                    dsp_tie_esp,
                                                                                                                    dsp_uni_t_esp, 'GEN',
                                                                                                                    fecha_dia);
                              ...
                              --
                                                    ...
                                                    v_edad_afiliado := trunc(((months_between(trunc(sysdate), fonos_row.fec_nac)) / 12),
                                                    0);
                                ...
                                /***************************************************/
                                  ...
                                  /***************************************************/
                                    ...
                                    /***************************************************/
                                                                ...
                                                                fonos_row.ramo, fonos_row.secuencial, fonos_row.plan, cod_ase,
                                                                                                                       fecha_dia, var_fec_ini,
                                                                                                                       fonos_row.fec_ing,
                                                                                                                       fonos_row.mon_pag,
                                                                                                                       NULL);
