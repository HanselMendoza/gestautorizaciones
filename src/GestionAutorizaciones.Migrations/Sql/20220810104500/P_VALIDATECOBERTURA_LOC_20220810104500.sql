...
--------------------------------------------------------
  ...
  CREATE OR REPLACE PROCEDURE "AUTORIZACIONES"."P_VALIDATECOBERTURA_LOC" (
        ...
        IF nvl(cod_ase, 0) <> 0 THEN
            ...
            /*Si se da esta condicion, todas las validaciones posteriores de coberturas deben hacerse bajo la configuracion del plan basico (ramo, secuencial, plan)*/
              ...
              --Solo debe funcionar para las polizas voluntarias
                ...
                --MCARRION 26/06/2019
                        red_excepcion_odon := dbaper.excepcion_poliza_odon(fonos_row.compania, fonos_row.ramo, fonos_row.secuencial, fonos_row.
                        tip_ser);
            ...
            --</jdeveaux>
              ...
              --
                ...
                /* --------------------------------------------------------------------- */
                  ...
                  --
                            ...
                            secuencial, fonos_row.plan, fonos_row.tip_ser,
                                                                                         fonos_row.tip_cob, p_mon_exe, p_uni_t_exe, p_ran_exe,
                                                                                         p_por_coa,
                                                                                         p_uni_t_max);
                  --
                        END IF;
                ...
                /* --------------------------------------------------------------------- */
                        error := paq_matriz_validaciones.chk_cobertura_asegurado_fono(true, fonos_row.tip_rec, fonos_row.afiliado, des_tip_n_med,
                        var_tip_a_uso,
                                                                                     cod_ase, cod_dep, fonos_row.compania, fonos_row.
                                                                                     ramo, fonos_row.secuencial,
                                                                                     fonos_row.plan, fonos_row.tip_ser, fonos_row.tip_cob,
                                                                                     fonos_row.cobertura, var_tip_ser2,
                                                                                     fecha_dia, fonos_row.sexo, fonos_row.est_civ, var_categoria,
                                                                                     fonos_row.fec_nac,
                              ...
                              /*-------------------------------------------------------------- */
                                ...
                                /* a la Fecha de Servicio.      */
                                                        IF t_fec_fin IS NULL THEN
                                                            t_fec_fin := fecha_dia;
                                                        END IF;
                                                        p_mon_acum := paq_matriz_validaciones.buscar_rec_acumuladas(var_tip_a_uso, cod_ase,
