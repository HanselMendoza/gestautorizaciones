--------------------------------------------------------
--  DDL for Procedure P_ES_COBERTURA_LABORATORIO
--------------------------------------------------------


  CREATE OR REPLACE PROCEDURE "P_ES_COBERTURA_LABORATORIO" (P_COBERTURA  IN  NUMBER,
 ...
 /*
   **************************************************************************************************                                                              
   * Procedimiento para verificar si cobertura corresponde a Laboratorio.
   * Lorenzo Diaz
   * 15-06-2022
   **************************************************************************************************/    
  ...
  Cursor cob_lab is
    SELECT  CASE COUNT(tip_cob)
     ...
     --
       ...
       AND E.VAL_LOG      = 'T'
       AND TC.DESCRIPCION LIKE('LABORATORIO%') 
